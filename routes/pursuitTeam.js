...
router.all("/criar", wrap((req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    if (!u || !u.admin) {
        ...
        res.render("negocios/pursuitTeam/alterar", { titulo: "Criar Pursuit Team", usuario: u });
    }
})));
router.all("/alterar", wrap((req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    if (!u || !u.admin) {
        ...
        if (isNaN(id) || !(item = yield Usuario.obter(id)))
            ...
            res.render("negocios/pursuitTeam/alterar", { titulo: "Editar Pursuit Team", usuario: u });
    }
})));
router.get("/listar", wrap((req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    if (!u || !u.admin) {
        ...
        res.render("negocios/pursuitTeam/listar", { titulo: "Visualizar Pursuit Team", usuario: u });
    }
})));
module.exports = router;
//# sourceMappingURL=pursuitTeam.js.map