...
router.all("/criar", wrap((req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    if (!u || !u.admin) {
        ...
        res.render("inovacao/alterar", { titulo: "Criar Inovação", usuario: u });
    }
})));
router.all("/alterar", wrap((req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    if (!u || !u.admin) {
        ...
        if (isNaN(id) || !(item = yield Usuario.obter(id)))
            ...
            res.render("inovacao/alterar", { titulo: "Editar Inovação", usuario: u });
    }
})));
router.get("/listar", wrap((req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    if (!u || !u.admin) {
        ...
        res.render("inovacao/listar", { titulo: "Visualizar Inovação", usuario: u });
    }
})));
module.exports = router;
//# sourceMappingURL=inovacao.js.map